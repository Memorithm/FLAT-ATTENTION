// FLAT-ATTENTION qualified single-query-row baseline kernel.
//
// This is the M2/M3 fused kernel retained as an executable comparison point
// for later tiled generations. One workgroup computes one query row.
