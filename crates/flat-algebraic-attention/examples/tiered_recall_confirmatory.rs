//! MAA-13d tiered-recall confirmatory holdout evidence.
//! Preregistration: docs/research/MAA_13D_CONFIRMATORY_HOLDOUT_PREREGISTRATION.md.
...
const PROTOCOL: &str = "maa-tiered-recall-confirmatory/v1";
const DATASET_SEED: u64 = 0x004d_4141_2d31_3365;
